...
import { CODACY_PROJECT_KEY_ANNOTATION } from '../components';
import { useProjectInfo } from './useProjectInfo';
import { CODACY_PROJECT_INSTANCE_SEPARATOR } from './useProjectInfo';
...
describe('useProjectInfo', () => {
  ...
  it('parse annotation with key and instance', () => {
    const entity = createDummyEntity(
      DUMMY_INSTANCE + CODACY_PROJECT_INSTANCE_SEPARATOR + DUMMY_KEY,
    );
  ...
  it('parse annotation with instance, tenant/project-key', () => {
    ...
    const entity = createDummyEntity(
      DUMMY_INSTANCE +
        CODACY_PROJECT_INSTANCE_SEPARATOR +
  ...
  // compatibility with previous mono-instance codacy config
