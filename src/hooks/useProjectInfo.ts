...
export const CODACY_PROJECT_INSTANCE_SEPARATOR = '/';

/**
 *
 * Try to parse codacy information from an entity.
 *
 * If part or all info are not found, they will default to undefined
 *
 * @public
 * @param entity - entity to find the codacy information from.
...
export const useProjectInfo = (
  ...
  const annotation =
    entity?.metadata.annotations?.[CODACY_PROJECT_KEY_ANNOTATION];
  if (annotation) {
